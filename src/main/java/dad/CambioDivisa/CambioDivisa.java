...
public class CambioDivisa extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		cuadroTexto2.setEditable(false); //para no poder interactuar con el cuadros
        ...
        botones1.getItems().addAll(euro, libra, dolar, yen); //para hacer el desplegable
        botones1.getSelectionModel().select(euro); //para poner uno por defecto
	...
	public void onComprobarAction(ActionEvent e) {
		...
		try {
            ...
            double cantidad = Double.parseDouble(cuadroTexto1.getText()); //recoger datos primero
